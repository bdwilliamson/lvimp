...
remotes::install_github("bdwilliamson/lvimp")
```
...
* The area under the variable importance trajectory curve over a contiguous subset of the time series (`lvim_auc`)
...
# add on the AUC based on a piecewise linear trajectory
est_lvim <- lvim_auc(est_lvim, indices = 1:3)
